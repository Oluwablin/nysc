...
class StatesAndLGTableSeeder extends Seeder
{
    /**
    ...
    {
      if (Schema::hasTable('l_g_a_s')) {
        DB::insert($this->formatQuery('l_g_a_s'));
      }
    }
    ...
    {
      return "INSERT INTO l_g_a_s (id, state_id, name) VALUES
        (1, 1, 'Aba South'),
        (2, 1, 'Arochukwu'),
        (3, 1, 'Bende'),
        (4, 1, 'Ikwuano'),
